...
if (args.length < 2) {
  console.error('Usage: notify <type> <message> [--workspace-dir path] [--agent-role name] [--agent-number N] [--voice voice] [--model model] [--app name] [--project name] [--detail text] [--link url] [--image path]');
  process.exit(1);
}

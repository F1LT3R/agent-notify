    ...
    tools: [
      {
        ...
        inputSchema: {
          ...
          properties: {
            ...
            toProject: {
              type: "string",
              description: "Project name the message is directed to, when targeting an agent in a different project. Derived from the recipient's workspaceDir basename."
            }
          },
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  if (request.params.name === "notify") {
    const { type, message, workspaceDir, agentRole, agentNumber, voice, model, to, toProject } = request.params.arguments;
    ...
    if (toProject !== undefined) params.set('toProject', toProject);
